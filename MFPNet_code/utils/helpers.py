...
from utils.hybridloss import hybrid_loss
from models.MFPNet_model import MFPNET
...
def load_model(opt, device):
    ...
    """
    model = MFPNET(classes = 2).to(device)
